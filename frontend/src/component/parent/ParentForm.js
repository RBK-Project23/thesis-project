                ...
                <CardContent>
                  ...
                  >
                    <FormControlLabel
                      value="yes"
                      control={<Radio />}
                      label="Membre of the TSR"
                    />
                    <FormControlLabel
                      value="no"
                      control={<Radio />}
                      label="I'm not a Membre of the TSR"
                    />
                  </RadioGroup>
                  <RadioGroup
                    row
                  ...
                  >
                    <FormControlLabel
                      value="You have chronic diseases"
                      control={<Radio />}
                      label="I have chronic diseases"
                    />
                    <FormControlLabel
                      value="You don't have chronic diseases"
                      control={<Radio />}
