...
<div className="flex flex-col items-center justify-center gap-4 p-4">
              ...
              <button class="bg-transparent hover:bg-slate-950 text-slate-950 font-semibold hover:text-white py-2 px-4 border border-indigo-950 hover:border-transparent rounded">
  See More
</button>
            </div>
            </div>
